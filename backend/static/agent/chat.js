...
const TOOL_LABELS = {
  ...
  bulk_move_contacts_stage:'Меняю стадию группе контактов', bulk_cancel_calls:'Отменяю звонки группе',
...
const TOOL_ICONS = {
  ...
  bulk_move_contacts_stage:'fa-shuffle', bulk_cancel_calls:'fa-calendar-xmark',
