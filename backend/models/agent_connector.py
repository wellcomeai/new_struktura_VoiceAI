...
composio_user_id — идентификатор пользователя в Composio. Маппим на Voicyfy
user.id (одно подключение шарится между агентами одного владельца). И
оркестратор, и голосовой агент резолвят этот id из своего контекста.
