...
function errText(detail){
  const map = {
    ...
    api_key_required_fish:'Fish Audio временно недоступен: на платформе не настроен ключ.',
    ...
    exceed_limit:'Слишком много строк. Максимум 10 000 за один импорт.',
    file_too_large:'Файл слишком большой. Максимум 10 МБ.',
    import_failed:'Импорт прервался. Часть контактов могла загрузиться — проверьте список и повторите импорт: дубли пропустятся.',
    import_not_found:'Импорт не найден. Обновите страницу.',
