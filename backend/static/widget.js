 ...
 * Версия: 1.2.2 (Модифицированная для мобильных улучшений)
 *
 * Этот скрипт динамически создает и встраивает виджет голосового ассистента
 * на любой сайт. Улучшена поддержка мобильных устройств и iOS.
 * Внесены изменения для улучшения распознавания на Android
 * и предотвращения акустической обратной связи на iOS.
 */
