...
- **Мульти-провайдер с дублированием.** Пять видов голосовых ассистентов (OpenAI/Gemini/Grok/Cartesia/Translate) + ElevenLabs дублируются на каждом слое (model → api → handler → widget). Общая правка = правка во всех ветках.
