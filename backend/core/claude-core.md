...
- `check_subscription_active`, `check_subscription_active_for_assistants`, `check_assistant_limit`, `check_subscription_or_show_popup` — гейты по подписке/лимитам. Возвращают 402/403 при блокировке.
...
- В `dependencies.py` зашиты привилегированные email'ы (`well96well@gmail.com`, `stas@gmail.com`) и спец-лимиты ассистентов (`SPECIAL_ASSISTANT_LIMITS`) — обходят проверки подписки/лимитов.
