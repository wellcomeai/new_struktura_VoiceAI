...
ORCHESTRATOR_MODELS = [
    ...
    },
    {
        ...
        "description": "Самый сильный Flash от Google: заметный рост над 3.7 Flash в "
                       "агентных задачах и многошаговых рассуждениях. 1M контекст.",
        # Цена на OpenRouter на 04.09.2026 идёт со скидкой 50% ($0.75/$3.75 за 1M).
        # Если скидку снимут — вдвое поднять обе ставки здесь.
        **_rates(0.00075, 0.00375),
    },
    {
    ...
    },
    {
        ...
        "name": "GLM 5.3 Flash",
        "description": "Мультимодальная модель Z.ai для долгих агентных цепочек. "
                       "1.3M контекст. Одна из самых дешёвых в списке.",
        # Цена на OpenRouter на 04.09.2026 идёт со скидкой 50% ($0.075/$0.25 за 1M).
        # Если скидку снимут — вдвое поднять обе ставки здесь.
        **_rates(0.000075, 0.00025),
    },
    {
